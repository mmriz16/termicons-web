...
<ul class="nav nav-pills justify-content-center" style="margin-top: 87px;" id="pills-tab" role="tablist">
    <li class="nav-item mx-3" role="presentation">
        <button class="nav-link nav-custom btn-tab-icon active" id="pills-all-tab" data-icon="all" data-bs-toggle="pill" data-bs-target="#pills-all"
    ...
    <li class="nav-item mx-3" role="presentation">
        <button class="nav-link nav-custom btn-tab-icon" id="pills-solid-tab" data-icon="solid" data-bs-toggle="pill" data-bs-target="#pills-solid"
            type="button" role="tab" aria-controls="pills-solid" aria-selected="false">Solid</button>
    </li>
    <li class="nav-item mx-3" role="presentation">
        <button class="nav-link nav-custom btn-tab-icon" id="pills-logo-tab" data-icon="logo" data-bs-toggle="pill" data-bs-target="#pills-logo"
...
<div class="tab-content" id="pills-tabContent">
    ...
    <div class="tab-pane show active" style="margin-top: 87px;" id="pills-all" role="tabpanel" aria-labelledby="pills-all-tab">
        ...
        <div class="card mt-5" style="border: none; background-color: var(--black-5); border-radius: 10px;">
            <div class="input-group">
                ...
                <input type="text" class="form-control p-3 ti-search search-all" id="myInput" placeholder="Search..." onkeyup="iconSearch()">
            </div>
        </div>
        <p class="mt-2 d-flex justify-content-end" style="color: var(--black-50);" id="iconsTotal-all">1000 of 1000 icons</p>

        {{-- Modal All Style --}}
        <div class="d-flex flex-row justify-content-start mt-5 flex-wrap icon-full" id="iconList-all"></div>
        {{-- Modal All Style --}}
    </div>
        ...
        <div class="card mt-5" style="border: none; background-color: var(--black-5); border-radius: 10px;">
            <div class="input-group">
                <div class="input-group-text p-3" id="button-addon2"
                    style="border: none; background-color: rgba(0, 0, 0, 0);"><i class="ti ti-search ti-sm"
                        style="color: var(--black-70);"></i></div>
                <input type="search" class="form-control p-3 ti-search search-line" onkeyup="iconSearch()" placeholder="Search..."
                    aria-label="Recipient's username" aria-describedby="button-addon2">
            </div>
        </div>
        <p class="mt-2 d-flex justify-content-end" style="color: var(--black-50);" id="iconsTotal-line">1000 of 1000 icons</p>

        {{-- Content Line Style --}}
        <div class="d-flex flex-row justify-content-between mt-5 flex-wrap" id="iconList-line">
    ...
    <div class="tab-pane" style="margin-top: 87px;" id="pills-solid" role="tabpanel" aria-labelledby="pills-solid-tab">
        ...
        <p class="mt-2 d-flex justify-content-end" style="color: var(--black-50);" id="iconsTotal-solid">1000 of 1000 icons</p>

        {{-- Content Solid Style --}}
        <div class="d-flex flex-row justify-content-between mt-5 flex-wrap" id="iconList-solid">
        ...
        <div class="card mt-5" style="border: none; background-color: var(--black-5); border-radius: 10px;">
            <div class="input-group">
                <div class="input-group-text p-3" id="button-addon2"
                    style="border: none; background-color: rgba(0, 0, 0, 0);"><i class="ti ti-search ti-sm"
                        style="color: var(--black-70);"></i></div>
                <input type="search" class="form-control p-3 ti-search search-logo" onkeyup="iconSearch()" placeholder="Search..."
                    aria-label="Recipient's username" aria-describedby="button-addon2">
            </div>
        </div>
        <p class="mt-2 d-flex justify-content-end" style="color: var(--black-50);" id="iconsTotal-logo">1000 of 1000 icons</p>

        {{-- Content Logo Style --}}
        <div class="d-flex flex-row justify-content-between mt-5 flex-wrap" id="iconList-logo">
